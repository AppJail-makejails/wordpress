...
* `wp_tag` (default: `13.2-php82-apache-6.4.3`): see [#tags](#tags).
...
| ------------------------- | ------- | -------------- | ------ | ------------- |
| `13.2-php81-apache-6.4.3` | `amd64` | `13.2-RELEASE` | `thin` |    `6.4.3`    |
| `13.2-php82-apache-6.4.3` | `amd64` | `13.2-RELEASE` | `thin` |    `6.4.3`    |
| `13.2-php81-fpm-6.4.3`    | `amd64` | `13.2-RELEASE` | `thin` |    `6.4.3`    |
| `13.2-php82-fpm-6.4.3`    | `amd64` | `13.2-RELEASE` | `thin` |    `6.4.3`    |
