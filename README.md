...
* `wp_tag` (default: `13.4-php82-apache-6.6.1`): see [#tags](#tags).
...
| ------------------------- | ------- | -------------- | ------ | ------------- |
| `13.4-php81-apache-6.6.1` | `amd64` | `13.4-RELEASE` | `thin` |    `6.6.1`    |
| `13.4-php82-apache-6.6.1` | `amd64` | `13.4-RELEASE` | `thin` |    `6.6.1`    |
| `13.4-php81-fpm-6.6.1`    | `amd64` | `13.4-RELEASE` | `thin` |    `6.6.1`    |
| `13.4-php82-fpm-6.6.1`    | `amd64` | `13.4-RELEASE` | `thin` |    `6.6.1`    |
