...
UP      mariadb  thin  13.3-RELEASE  -      10.0.0.15
```
...
STATUS  NAME       TYPE  VERSION       PORTS  NETWORK_IP4
UP      wordpress  thin  13.3-RELEASE  -      10.0.0.22
```
...
* `wp_tag` (default: `13.3-php82-apache-6.4.3`): see [#tags](#tags).
...
| ------------------------- | ------- | -------------- | ------ | ------------- |
| `13.3-php81-apache-6.4.3` | `amd64` | `13.3-RELEASE` | `thin` |    `6.4.3`    |
| `13.3-php82-apache-6.4.3` | `amd64` | `13.3-RELEASE` | `thin` |    `6.4.3`    |
| `13.3-php81-fpm-6.4.3`    | `amd64` | `13.3-RELEASE` | `thin` |    `6.4.3`    |
| `13.3-php82-fpm-6.4.3`    | `amd64` | `13.3-RELEASE` | `thin` |    `6.4.3`    |
| `14.0-php81-apache-6.4.3` | `amd64` | `14.0-RELEASE` | `thin` |    `6.4.3`    |
| `14.0-php82-apache-6.4.3` | `amd64` | `14.0-RELEASE` | `thin` |    `6.4.3`    |
| `14.0-php81-fpm-6.4.3`    | `amd64` | `14.0-RELEASE` | `thin` |    `6.4.3`    |
| `14.0-php82-fpm-6.4.3`    | `amd64` | `14.0-RELEASE` | `thin` |    `6.4.3`    |
