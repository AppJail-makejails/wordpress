...
* `wp_tag` (default: `13.3-php82-apache-6.4.4`): see [#tags](#tags).
...
| ------------------------- | ------- | -------------- | ------ | ------------- |
| `13.3-php81-apache-6.4.4` | `amd64` | `13.3-RELEASE` | `thin` |    `6.4.4`    |
| `13.3-php82-apache-6.4.4` | `amd64` | `13.3-RELEASE` | `thin` |    `6.4.4`    |
| `13.3-php81-fpm-6.4.4`    | `amd64` | `13.3-RELEASE` | `thin` |    `6.4.4`    |
| `13.3-php82-fpm-6.4.4`    | `amd64` | `13.3-RELEASE` | `thin` |    `6.4.4`    |
| `14.0-php81-apache-6.4.4` | `amd64` | `14.0-RELEASE` | `thin` |    `6.4.4`    |
| `14.0-php82-apache-6.4.4` | `amd64` | `14.0-RELEASE` | `thin` |    `6.4.4`    |
| `14.0-php81-fpm-6.4.4`    | `amd64` | `14.0-RELEASE` | `thin` |    `6.4.4`    |
| `14.0-php82-fpm-6.4.4`    | `amd64` | `14.0-RELEASE` | `thin` |    `6.4.4`    |
